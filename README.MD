...
In this session, we put the spotlight on model customization. Learn what your options are, and why _fine-tuning_ might be the right option for your scenario. Learn about the various fine-tuning options in Microsoft Foundry, and build your intuition for using techniques like Distillation (for reducing cost) and SFT (for improving tone) with hands-on demos. Walk away with resources and insights that help you streamline your end-to-end model optimization journey with Microsoft Foundry.
...
1. Use Microsoft Foundry to generate synthetic data 
