...
| Recorded Demo 1 | [Video](https://aka.ms/AAz1yuv) | Reviews the [01-custom-grader](./../src/02-custom-grader.ipynb) and [01-distillation](./../src/02-distillation.ipynb) notebooks for demo 1|
| Recorded Demo 2 | [Video](https://aka.ms/AAz1yux) | Reviews the [02-basic-fine-tuning](./../src/01-basic_fine-tuning.ipynb) notebook for demo 2 |
