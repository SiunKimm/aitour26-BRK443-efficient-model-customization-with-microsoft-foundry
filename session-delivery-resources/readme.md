...
| Recorded Demo 1 | [Video](https://aka.ms/AAz1yux) | Reviews the [01-basic-fine-tuning](./../src/01-basic_fine-tuning.ipynb) notebook for demo 2 |
| Recorded Demo 2 | [Video](https://aka.ms/AAz1yuw) | Reviews the [02-tool-calling-fine-tuning](./../src/03-tool-calling-fine-tuning.ipynb) notebook for demo 3 |
| | |
...
| 30 min | Row 4 | Walk through the 2 demos, use slides if/when needed |
